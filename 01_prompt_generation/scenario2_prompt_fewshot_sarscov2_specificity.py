...
for test, few_shot in tqdm(zip(test_examples, bcr_examples)):
    prompt_list_notag.extend([create_prompt(test[0], few_shot, example_tag=False)])
    prompt_list_tag.extend([create_prompt(test[0], few_shot, example_tag=True)])
